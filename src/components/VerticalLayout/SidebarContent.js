      ...
      <SimpleBar style={{ maxHeight: "100%" }} ref={ref} className="sidebar-menu-scroll">
            ...
            */}
            ...
            <li>
              <Link to="/calendar" className=" waves-effect">
                <i className="uil-book-alt"></i>
                <span>{props.t("New Account Form")}</span>
              </Link>
            </li>
            ...
            {/*<li>
              <Link to="/#" className=" waves-effect">
                ...
                <span>{props.t("Equipment Calculator")}</span>
              </Link>
            </li>*/}
            ...
            <li>
              <Link to="/#" className=" waves-effect">
                ...
                <span>{props.t("Digital Route Card")}</span>
              </Link>
            </li>
            ...
            {/*<li>
              <Link to="/#" className=" waves-effect">
                ...
                <span>{props.t("Product Information")}</span>
              </Link>
            </li>*/}

            <li>
              <Link to="/#" className=" waves-effect">
                <i className="uil-pricetag-alt"></i>
                <span>{props.t("Quoted Price Request")}</span>
              </Link>
            </li>
            ...
            <li>
              <Link to="/#" className=" waves-effect">
                ...
                <span>{props.t("Purchase Agreement")}</span>
              </Link>
            </li>
            ...
            <li>
              <Link to="/#" className=" waves-effect">
                <i className="uil-package"></i>
                <span>{props.t("Rental Agreement")}</span>
              </Link>
            </li>
            ...
            <li>
              <Link to="/#" className=" waves-effect">
                <i className="uil-package"></i>
                <span>{props.t("Equipment Agreement")}</span>
              </Link>
            </li>
          ...
          */}
          <li className={linkPathName.search("newaccountpt")>-1?"mm-active":""}>
            ...
            <li>
              <Link to="/#" className=" waves-effect">
                <i className="uil-book-alt"></i>
                <span>{props.t("Existing Account")}</span>
              </Link>
            </li>
        ...
        */}
            ...
            <li>
              ...
              <ul className="sub-menu">
                <li>
                  <Link to="/maps-google">{props.t("Google Maps111")}</Link>
                </li>
                <li>
